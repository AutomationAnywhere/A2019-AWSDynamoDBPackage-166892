...
@BotCommand
@CommandPkg(label = "Start Session", name = "StartDYNDBSession", description = "Start DynamoDB session", 
icon = "pkg.svg", comment = true ,  text_color = "#FF9900" , background_color =  "#FF9900"  ,node_label = "Start DynamoDB Session {{sessionName}}") 
public class StartSessionAWSDynamoDB {
	...
	private AWSDynamoDBConnection connection;
    ...
    public void start(@Idx(index = "1", type = TEXT) @Pkg(label = "Session Name",  default_value_type = STRING, default_value = "Default") @NotEmpty String sessionName,
	    ...
	    this.connection = new AWSDynamoDBConnection(accesskey,secretkey,region);
