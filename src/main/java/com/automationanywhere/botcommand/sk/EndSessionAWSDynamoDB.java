...
@BotCommand
@CommandPkg( label = "End Session", name = "EndDYNDBSession", description = "End DynamoDB Session", icon = "pkg.svg" ,node_label = "End DynamoDB Session {{sessionName}}" , comment = true , text_color = "#FF9900" , background_color =  "#FF9900" )
public class EndSessionAWSDynamoDB {
